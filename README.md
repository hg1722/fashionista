...
After observing the trouble that the GAN had with differentiating with different types of clothing, we experimented with replacing that condition with different fashion types instead. 
...
aGlzdG9yeSI6Wy0xMDMyMjk2NjgzLC0xMzEwMTQwNTE5LC0yMD
